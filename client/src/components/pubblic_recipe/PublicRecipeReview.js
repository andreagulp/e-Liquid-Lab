...
class PublicRecipeReview extends Component {
    ...
    handleOpenReviewForm = () => { this.setState({ openReviewForm: true }) };
    handleCloseReviewForm = () => { this.setState({ openReviewForm: false }) };
...
const mapStateToProps = (state) => { return { reviews: state.reviews, user: state.user } }
const mapDispatchToProps = (dispatch) => bindActionCreators({ fetchRecipeReview }, dispatch)

export default connect(mapStateToProps, mapDispatchToProps)(PublicRecipeReview)
